...
##########################################
# section 7.2.2 Na�ve Bayes Classifier
##########################################
...
banktrain <- read.table("D:/M.Tech Notes/DATA SCIENCE/DSV Lab/NaiveBayes/bank-sample.csv",header=TRUE,sep=",")
...
##########################################
# section 7.2.5 Na�ve Bayes in R
##########################################

install.packages("e1071") # install package e1071
library(e1071) # load the library

sample <- read.table("D:/M.Tech Notes/DATA SCIENCE/DSV Lab/NaiveBayes/sample1.csv",header=TRUE,sep=",")
print(sample)
